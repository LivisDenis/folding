...
(() => {
  ...
  function nt(e) {
    ...
    return (
      !0 === e
        ? (t.className = Te)
        : ((t.className = Ce), $e(e) ? t.appendChild(e) : it(t, e)),
      t
    );
  }
  function st(e, t) {
  ...
  function ct(e, t) {
    ...
    function j() {
      ...
      e.addEventListener("mousedown", B, !0),
        e.addEventListener("touchend", B, Se),
        e.addEventListener("touchstart", N, Se),
        e.addEventListener("touchmove", G, Se);
    }
    function H() {
      var e = k();
      e.removeEventListener("mousedown", B, !0),
        e.removeEventListener("touchend", B, Se),
        e.removeEventListener("touchstart", N, Se),
        e.removeEventListener("touchmove", G, Se);
    }
    function V(e, t) {
      var i = M().box;
      function n(e) {
  ...
  Object.keys(St).forEach((e) => {
    Object.defineProperty(xt.fn, e, { value: St[e], writable: !0 });
  });
  const Et = xt;
  function Ot(e, t = 0) {
  ...
  var fi = (function () {
    ...
    return (
      ...
      (e.prototype.find = function (e) {
        return gi(this._getSelector(e, this.selector));
      }),
      ...
      (e.prototype.eq = function (e) {
        return gi(this.selector[e]);
      }),
      (e.prototype.parent = function () {
        return gi(this.selector.parentElement);
      }),
  ...
  var yi = function (e, t, i, n) {
      void 0 === i && (i = 0);
      var s = gi(e).attr("data-lg-size") || n;
      if (s) {
        var r = s.split(",");
        if (r[1])
    ...
    bi = function (e, t, i, n, s) {
      if (s) {
        var r = gi(e).find("img").first();
        if (r.get()) {
    ...
    ki = "lgAfterAppendSlide",
    Mi = "lgInit",
    Ai = "lgHasVideo",
    Pi = "lgContainerResize",
    Di = "lgUpdateSlides",
    _i = "lgAfterAppendSubHtml",
    zi = "lgBeforeOpen",
    $i = "lgAfterOpen",
    Bi = "lgSlideItemLoad",
    Gi = "lgBeforeSlide",
      ...
      return (
        ...
        (e.prototype.init = function () {
          ...
          this.addSlideVideoInfo(this.galleryItems),
            this.buildStructure(),
            this.LGel.trigger(Mi, { instance: this }),
        ...
        (e.prototype.getSlideItem = function (e) {
          return gi(this.getSlideItemId(e));
        }),
          ...
          if (!(this.$container && this.$container.get())) {
            ...
            var s = this.settings.ariaLabelledby
              ...
              d =
                ...
                "\n                </div>\n            </div>\n        </div>\n        ";
            gi(this.settings.container).css("position", "relative").append(d),
          ...
          if ("this" === this.settings.selector) this.items.push(this.el);
            ...
            if ("string" == typeof this.settings.selector)
              if (this.settings.selectWithin) {
                var e = gi(this.settings.selectWithin);
        ...
        (e.prototype.openGallery = function (e, t) {
          ...
          if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (r = bi(t, this.outer, a, l, this.currentImageSize))),
            ...
            setTimeout(function () {
              ...
              (this.lGalleryOn = !1),
              (this.prevScrollTop = gi(window).scrollTop()),
              setTimeout(function () {
        ...
        (e.prototype.addHtml = function (e) {
            ...
            if (t) {
              ...
              ("." !== n && "#" !== n) ||
                (t =
                  ...
                  !this.settings.dynamic
                    ? gi(this.items).eq(e).find(t).first().html()
                    : gi(t).first().html());
            } else t = "";
          if (".lg-item" !== this.settings.appendSubHtmlTo)
            ...
            var s = gi(this.getSlideItemId(e));
            i
              ? s.load(i)
        ...
        (e.prototype.getDummyImageContent = function (e, t, i) {
          var n;
          if ((this.settings.dynamic || (n = gi(this.items).eq(t)), n)) {
            var s = void 0;
            if (
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, i, n, s) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              r.LGel.trigger(Bi, { index: t, delay: i || 0, isFirstSlide: s });
          }, a);
        }),
        ...
        (e.prototype.addSlideVideoInfo = function (e) {
          ...
          e.forEach(function (e, i) {
            (e.__slideVideoInfo = Ii(e.src, !!e.video, i)),
              e.__slideVideoInfo &&
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            (r || h) &&
              ...
              this.LGel.trigger(ki, { index: e }),
              this.lGalleryOn &&
                ".lg-item" === this.settings.appendSubHtmlTo &&
                this.addHtml(e);
          }
          var E = 0;
          v && !gi(document.body).hasClass("lg-from-hash") && (E = v),
            this.isFirstSlideWithZoomAnimation() &&
              (setTimeout(function () {
                s.removeClass(
          ...
          "lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"),
            setTimeout(function () {
              ...
              if (
                ...
                var a = gi(i.target);
                s.isPosterElement(a) && s.LGel.trigger(ji);
              }
            ...
            this.$inner.on("touchend.lg", function (r) {
              if ("swipe" === e.touchAction) {
                if (n) (n = !1), e.touchEnd(i, t, r);
                  ...
                  var o = gi(r.target);
                  e.isPosterElement(o) && e.LGel.trigger(ji);
                }
        ...
        (e.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            gi(window).on("mousemove.lg.global" + this.lgId, function (r) {
              n &&
                e.lgOpened &&
                ((s = !0),
            ...
            gi(window).on("mouseup.lg.global" + this.lgId, function (r) {
              if (e.lgOpened) {
                var o = gi(r.target);
                s
                  ? ((s = !1), e.touchEnd(i, t, r), e.LGel.trigger(Fi))
                  : e.isPosterElement(o) && e.LGel.trigger(ji),
                  n &&
                    ((n = !1),
        ...
        (e.prototype.keyPress = function () {
          var e = this;
          gi(window).on("keydown.lg.global" + this.lgId, function (t) {
            e.lgOpened &&
              !0 === e.settings.escKey &&
              27 === t.keyCode &&
              (t.preventDefault(),
        ...
        (e.prototype.closeGallery = function (e) {
          ...
          this.LGel.trigger(qi), gi(window).scrollTop(this.prevScrollTop);
          var i,
          ...
          return (
            ...
            setTimeout(function () {
              t.zoomFromOrigin &&
                ...
                t.$inner.empty(),
                t.lgOpened && t.LGel.trigger(Xi, { instance: t }),
          ...
          return (
            setTimeout(function () {
              e.destroyModules(!0),
                ...
                gi(window).off(".lg.global" + e.lgId),
                e.LGel.off(".lg"),
                e.$container.remove();
            }, t),
            t
  ...
  Qi.length &&
    Qi.forEach((e) => {
      Ki(e, { licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E", speed: 500 });
    });
  let Ji = new IntersectionObserver(
      function (e) {
        e.forEach((e) => {
          e.isIntersecting &&
    ...
    Zi = document.querySelectorAll(".sale,.areas");
  for (let e of Zi) Ji.observe(e);
  (window.FLS = !0),
    (function (e) {
      let t = new Image();
      (t.onload = t.onerror =
