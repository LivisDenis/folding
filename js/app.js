...
(() => {
  ...
  function pe(e, t) {
    ...
    var i = t,
      ...
      g = i.padding,
      v = void 0 === g ? 0 : g,
      y = ce("number" != typeof v ? v : ue(v, D)),
      b = u === B ? "reference" : B,
      w = e.rects.popper,
      x = e.elements[f ? b : u],
      T = de(a(x) ? x : x.contextElement || m(e.elements.popper), o, d),
      S = h(e.elements.reference),
      C = K({ reference: S, element: w, strategy: "absolute", placement: s }),
      E = ae(Object.assign({}, w, C)),
      O = u === B ? E : S,
      I = {
  ...
  const ge = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        m = i.tetherOffset,
        v = void 0 === m ? 0 : m,
        y = pe(t, { boundary: l, rootBoundary: d, padding: h, altBoundary: p }),
        b = X(t.placement),
        w = Y(t.placement),
        T = !w,
        S = U(b),
      ...
      if (E) {
        if (r) {
          var G,
            ...
            ae = null != (G = null == $ ? void 0 : $[S]) ? G : 0,
            le = V + se - ae,
            de = fe(g ? u(F, V + ne - ae - oe) : F, V, g ? c(W, le) : W);
          (E[S] = de), (B[S] = de - V);
        }
        if (a) {
          var ce,
    ...
    fn: function (e) {
      ...
      if (r && o) {
        var c = (function (e, t) {
          ...
          S = fe(b, T, w),
          C = l;
        i.modifiersData[n] = (((t = {})[C] = S), (t.centerOffset = S - T), t);
      }
    },
    effect: function (e) {
      var t = e.state,
  ...
  function Ye() {
    ...
    e - qe < 20 &&
      ((Re.isTouch = !1), document.removeEventListener("mousemove", Ye)),
      (qe = e);
  }
  function Ue() {
  ...
  function et(e) {
    var t = (e.plugins || []).reduce(function (t, i) {
      var n,
        s = i.name,
        r = i.defaultValue;
      s && (t[s] = void 0 !== e[s] ? e[s] : null != (n = Je[s]) ? n : r);
      return t;
    }, {});
  ...
  function tt(e, t) {
    ...
    return (
      (i.aria = Object.assign({}, Je.aria, i.aria)),
      (i.aria = {
  ...
  function nt(e) {
    ...
    return (
      !0 === e
        ? (t.className = Te)
        : ((t.className = Se), $e(e) ? t.appendChild(e) : it(t, e)),
      t
    );
  }
  function st(e, t) {
    ...
    function s(i, n) {
      ...
      n.theme
        ...
        n.arrow
          ? a
            ? i.arrow !== n.arrow &&
              (r.removeChild(a), r.appendChild(nt(n.arrow)))
            : r.appendChild(nt(n.arrow))
          : a && r.removeChild(a);
    }
    return (
      (n.className = we),
  ...
  function ct(e, t) {
    var i,
      ...
      l,
      d,
      c = tt(e, Object.assign({}, Je, et(_e(t)))),
      u = !1,
      p = !1,
      h = !1,
      f = !1,
      g = [],
      m = ke(X, c.interactiveDebounce),
      v = at++,
      ...
      b = {
        ...
        setProps: function (t) {
          ...
          var i = b.props,
            n = tt(e, Object.assign({}, i, _e(t), { ignoreAttributes: !0 }));
          (b.props = n),
            W(),
            i.interactiveDebounce !== n.interactiveDebounce &&
              ($(), (m = ke(X, n.interactiveDebounce)));
          i.triggerTarget && !n.triggerTarget
            ? Me(i.triggerTarget).forEach(function (e) {
        ...
        show: function () {
          ...
          var e = b.state.isVisible,
            ...
            s = Oe(b.props.duration, 0, Je.duration);
          if (e || t || i || n) return;
        ...
        hide: function () {
          ...
          var e = !b.state.isVisible,
            t = b.state.isDestroyed,
            i = !b.state.isEnabled,
            n = Oe(b.props.duration, 1, Je.duration);
          if (e || t || i) return;
          ...
          if (($(), H(), P(!0), I())) {
            var s = M(),
              r = s.box,
              o = s.content;
            b.props.animation && (je([r, o], n), He([r, o], "hidden"));
          }
          _(),
            z(),
            b.props.animation
        ...
        hideWithInteractivity: function (e) {
          0;
          k().addEventListener("mousemove", m), Ae(lt, m), m(e);
        },
        enable: function () {
          b.state.isEnabled = !0;
        },
    ...
    function A(e) {
      return (b.state.isMounted && !b.state.isVisible) ||
        ...
        (r && "focus" === r.type)
        ? 0
        : Oe(b.props.delay, e ? 0 : 1, Je.delay);
    }
    function P(e) {
      void 0 === e && (e = !1),
    ...
    function B(t) {
      if (!Re.isTouch || (!h && "mousedown" !== t.type)) {
        var i = (t.composedPath && t.composedPath()[0]) || t.target;
        if (!b.props.interactive || !We(x, i)) {
          if (
    ...
    function j() {
      ...
      e.addEventListener("mousedown", B, !0),
        e.addEventListener("touchend", B, Ce),
        e.addEventListener("touchstart", N, Ce),
        e.addEventListener("touchmove", G, Ce);
    }
    function H() {
      var e = k();
      e.removeEventListener("mousedown", B, !0),
        e.removeEventListener("touchend", B, Ce),
        e.removeEventListener("touchstart", N, Ce),
        e.removeEventListener("touchmove", G, Ce);
    }
    function V(e, t) {
      var i = M().box;
      function n(e) {
        e.target === i && (Fe(i, "remove", n), t());
      }
      if (0 === e) return t();
      Fe(i, "remove", o), Fe(i, "add", n), (o = n);
    }
    function F(t, i, n) {
      void 0 === n && (n = !1),
        Me(b.props.triggerTarget || e).forEach(function (e) {
  ...
  function ut(e, t) {
    void 0 === t && (t = {});
    var i = Je.plugins.concat(t.plugins || []);
    document.addEventListener("touchstart", Xe, Ce),
  ...
  function bt(e = []) {
    ...
    return (
      e.forEach((e) => {
        Array.isArray(e) ? t.push(...bt(e)) : t.push(e);
      }),
      t
    );
  }
    ...
    return function (...t) {
      if (void 0 === t[0]) {
        for (let t = 0; t < this.length; t += 1)
          Tt.indexOf(e) < 0 &&
            (e in this[t] ? this[t][e]() : xt(this[t]).trigger(e));
        return this;
      }
      return this.on(e, ...t);
    };
  ...
  const Ct = {
    ...
    on: function (...e) {
      ...
      function r(e) {
        ...
        if ((s.indexOf(e) < 0 && s.unshift(e), xt(t).is(i))) n.apply(t, s);
        else {
          const e = xt(t).parents();
          for (let t = 0; t < e.length; t += 1)
            xt(e[t]).is(i) && n.apply(e[t], s);
        }
      }
      function o(e) {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (s = xt(e), r = 0; r < s.length; r += 1) if (s[r] === n) return !0;
        return !1;
      }
      if (e === i) return n === i;
      if (e === t) return n === t;
    ...
    next: function (e) {
      return this.length > 0
        ? e
          ? this[0].nextElementSibling && xt(this[0].nextElementSibling).is(e)
    ...
    nextAll: function (e) {
      ...
      for (; i.nextElementSibling; ) {
        ...
        e ? xt(n).is(e) && t.push(n) : t.push(n), (i = n);
      }
      return xt(t);
    },
    prev: function (e) {
      if (this.length > 0) {
        const t = this[0];
        return e
          ? t.previousElementSibling && xt(t.previousElementSibling).is(e)
            ? xt([t.previousElementSibling])
            : xt([])
    ...
    parent: function (e) {
      ...
      for (let i = 0; i < this.length; i += 1)
        null !== this[i].parentNode &&
          (e
            ? xt(this[i].parentNode).is(e) && t.push(this[i].parentNode)
    ...
    parents: function (e) {
      ...
      for (let i = 0; i < this.length; i += 1) {
        ...
        for (; n; )
          e ? xt(n).is(e) && t.push(n) : t.push(n), (n = n.parentNode);
      }
      return xt(t);
    },
    closest: function (e) {
      let t = this;
      return void 0 === e ? xt([]) : (t.is(e) || (t = t.parents(e).eq(0)), t);
    },
    find: function (e) {
      const t = [];
      for (let i = 0; i < this.length; i += 1) {
  ...
  Object.keys(Ct).forEach((e) => {
    Object.defineProperty(xt.fn, e, { value: Ct[e], writable: !0 });
  });
  const Et = xt;
  function Ot(e, t = 0) {
          ...
          void 0 !== s &&
            ...
            (kt(t[n]) && kt(r[n])
              ? r[n].__swiper__
                ...
                : Mt(t[n], r[n])
              : !kt(t[n]) && kt(r[n])
              ? ((t[n] = {}), r[n].__swiper__ ? (t[n] = r[n]) : Mt(t[n], r[n]))
              : (t[n] = r[n]));
        }
      }
    }
  ...
  function Pt({ swiper: e, targetPosition: t, side: i }) {
    const n = vt(),
      s = -e.translate;
    let r,
      o = null;
  ...
  const jt = {
    ...
    updateSlides: function () {
      ...
      "string" == typeof b &&
        ...
        n.centeredSlides &&
          n.cssMode &&
          (At(e.wrapperEl, "--swiper-centered-offset-before", ""),
          At(e.wrapperEl, "--swiper-centered-offset-after", ""));
      ...
      if (
        ...
        At(e.wrapperEl, "--swiper-centered-offset-before", -p[0] + "px"),
          At(
            e.wrapperEl,
      ...
      (t.clickedSlide = n),
        t.virtual && t.params.virtual.enabled
          ? (t.clickedIndex = parseInt(
              Et(n).attr("data-swiper-slide-index"),
              10
            ))
          : (t.clickedIndex = s),
      ...
      if (
        ...
        if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!r.support.smoothScroll)
            return (
              Pt({ swiper: r, targetPosition: -c, side: e ? "left" : "top" }),
              !0
            );
  ...
  function Vt({ swiper: e, runCallbacks: t, direction: i, step: n }) {
  ...
  const Ft = {
    slideTo: function (e = 0, t = this.params.speed, i = !0, n, s) {
      ...
      if (a.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!r.support.smoothScroll)
            return (
              Pt({ swiper: r, targetPosition: i, side: e ? "left" : "top" }), !0
            );
    ...
    slideToClickedSlide: function () {
      ...
      if (t.loop) {
        ...
        (s = parseInt(Et(e.clickedSlide).attr("data-swiper-slide-index"), 10)),
          t.centeredSlides
  ...
  const Wt = {
    loopCreate: function () {
      const e = this,
        ...
        s = n.children().length > 0 ? Et(n.children()[0].parentNode) : n;
      ...
      for (let e = 0; e < a.length; e += 1)
        s.append(Et(a[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
      for (let e = o.length - 1; e >= 0; e -= 1)
        s.prepend(Et(o[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  function Rt(e) {
    ...
    if (
      ...
      d.is(s.focusableElements) && (e = !1),
        i.activeElement &&
          Et(i.activeElement).is(s.focusableElements) &&
          i.activeElement !== d[0] &&
  ...
  function qt(e) {
    ...
    if (
      ...
      Et(l.target).is(n.focusableElements)
    )
  ...
  const ei = {
      attachEvents: function () {
        ...
        (e.onTouchStart = Rt.bind(e)),
          ...
          i.cssMode && (e.onScroll = Kt.bind(e)),
          (e.onClick = Ut.bind(e)),
          n.touch && !Qt && (t.addEventListener("touchstart", Jt), (Qt = !0)),
          Zt(e, "on");
      },
    ...
    ti = (e, t) => e.grid && t.grid && t.grid.rows > 1;
  const ii = {
    setBreakpoint: function () {
      ...
      p && i && e.changeDirection(), Mt(e.params, l);
  ...
  const oi = {
      ...
      transition: {
        ...
        transitionStart: function (e = !0, t) {
          ...
          n.cssMode ||
            ...
            Vt({ swiper: i, runCallbacks: e, direction: t, step: "Start" }));
        },
        transitionEnd: function (e = !0, t) {
          ...
          (i.animating = !1),
            n.cssMode ||
              (i.setTransition(0),
              Vt({ swiper: i, runCallbacks: e, direction: t, step: "End" }));
        },
      },
      slide: Ft,
      loop: Wt,
      ...
      images: {
        loadImage: function (e, t, i, n, s, r) {
          ...
          Et(e).parent("picture")[0] || (e.complete && s)
            ? l()
            : t
            ? ((a = new o.Image()),
              (a.onload = l),
  ...
  class li {
    constructor(...e) {
      ...
      (n.__swiper__ = !0),
        (n.support = $t()),
        (n.device = Bt({ userAgent: i.userAgent })),
        (n.browser = Gt()),
        (n.eventsListeners = {}),
    ...
    mount(e) {
      ...
      let s = (() => {
        if (e && e.shadowRoot && e.shadowRoot.querySelector) {
          const t = Et(e.shadowRoot.querySelector(n()));
    ...
    static installModule(e) {
      li.prototype.__modules__ || (li.prototype.__modules__ = []);
      const t = li.prototype.__modules__;
      "function" == typeof e && t.indexOf(e) < 0 && t.push(e);
    }
    static use(e) {
      return Array.isArray(e)
        ? (e.forEach((e) => li.installModule(e)), li)
        : (li.installModule(e), li);
    }
  }
  Object.keys(oi).forEach((e) => {
    Object.keys(oi[e]).forEach((t) => {
      li.prototype[t] = oi[e][t];
    });
  }),
    li.use([
  ...
  const di = li;
  function ci({ swiper: e, extendParams: t, on: i, emit: n }) {
    function s(t) {
      let i;
      return (
        t &&
    ...
    t({
      ...
      i("click", (t, i) => {
        const { $nextEl: s, $prevEl: r } = e.navigation,
          o = i.target;
        if (e.params.navigation.hideOnClick && !Et(o).is(r) && !Et(o).is(s)) {
          if (
            e.pagination &&
            e.params.pagination &&
  ...
  function ui({ swiper: e, extendParams: t, on: i, emit: n }) {
    let s;
    function r() {
    ...
    (e.autoplay = { running: !1, paused: !1 }),
      ...
      i("init", () => {
        if (e.params.autoplay.enabled) {
          o();
          gt().addEventListener("visibilitychange", d),
      ...
      i("destroy", () => {
        ...
        gt().removeEventListener("visibilitychange", d);
      }),
  ...
  window.addEventListener("load", function (e) {
    pi(),
      document.querySelector(".glass-partition__slider") &&
        new di(".glass-partition__slider", {
          modules: [ci],
          effect: "fade",
  ...
  var gi = (function () {
    ...
    return (
      ...
      (e.prototype.find = function (e) {
        return mi(this._getSelector(e, this.selector));
      }),
      ...
      (e.prototype.eq = function (e) {
        return mi(this.selector[e]);
      }),
      (e.prototype.parent = function () {
        return mi(this.selector.parentElement);
      }),
  ...
  var bi = function (e, t, i, n) {
      void 0 === i && (i = 0);
      var s = mi(e).attr("data-lg-size") || n;
      if (s) {
        var r = s.split(",");
        if (r[1])
    ...
    wi = function (e, t, i, n, s) {
      if (s) {
        var r = mi(e).find("img").first();
        if (r.get()) {
    ...
    Mi = "lgAfterAppendSlide",
    Ai = "lgInit",
    Pi = "lgHasVideo",
    Di = "lgContainerResize",
    _i = "lgUpdateSlides",
    zi = "lgAfterAppendSubHtml",
    $i = "lgBeforeOpen",
    Bi = "lgAfterOpen",
    Gi = "lgSlideItemLoad",
    Ni = "lgBeforeSlide",
    ...
    Fi = "lgDragMove",
    Wi = "lgDragEnd",
    Ri = "lgBeforeNextSlide",
    qi = "lgBeforePrevSlide",
    Xi = "lgBeforeClose",
    Yi = "lgAfterClose",
    Ui = 0,
    Ki = (function () {
      ...
      return (
        (e.prototype.generateSettings = function (e) {
          if (
            ...
            var t = fi(
              fi({}, this.settings.mobileSettings),
              this.settings.mobileSettings
            );
            this.settings = fi(fi({}, this.settings), t);
          }
        }),
        ...
        (e.prototype.init = function () {
          ...
          this.addSlideVideoInfo(this.galleryItems),
            this.buildStructure(),
            this.LGel.trigger(Ai, { instance: this }),
        ...
        (e.prototype.getSlideItem = function (e) {
          return mi(this.getSlideItemId(e));
        }),
          ...
          if (!(this.$container && this.$container.get())) {
            ...
            var s = this.settings.ariaLabelledby
              ...
              d =
                ...
                "\n                </div>\n            </div>\n        </div>\n        ";
            mi(this.settings.container).css("position", "relative").append(d),
          ...
          if ("this" === this.settings.selector) this.items.push(this.el);
            ...
            if ("string" == typeof this.settings.selector)
              if (this.settings.selectWithin) {
                var e = mi(this.settings.selectWithin);
        ...
        (e.prototype.openGallery = function (e, t) {
          ...
          if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (r = wi(t, this.outer, a, l, this.currentImageSize))),
            ...
            setTimeout(function () {
              ...
              (this.lGalleryOn = !1),
              (this.prevScrollTop = mi(window).scrollTop()),
              setTimeout(function () {
        ...
        (e.prototype.addHtml = function (e) {
            ...
            if (t) {
              ...
              ("." !== n && "#" !== n) ||
                (t =
                  ...
                  !this.settings.dynamic
                    ? mi(this.items).eq(e).find(t).first().html()
                    : mi(t).first().html());
            } else t = "";
          if (".lg-item" !== this.settings.appendSubHtmlTo)
            ...
            var s = mi(this.getSlideItemId(e));
            i
              ? s.load(i)
        ...
        (e.prototype.getDummyImageContent = function (e, t, i) {
          var n;
          if ((this.settings.dynamic || (n = mi(this.items).eq(t)), n)) {
            var s = void 0;
            if (
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, i, n, s) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              r.LGel.trigger(Gi, { index: t, delay: i || 0, isFirstSlide: s });
          }, a);
        }),
        ...
        (e.prototype.addSlideVideoInfo = function (e) {
          ...
          e.forEach(function (e, i) {
            (e.__slideVideoInfo = Li(e.src, !!e.video, i)),
              e.__slideVideoInfo &&
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            (r || h) &&
              ...
              this.LGel.trigger(Mi, { index: e }),
              this.lGalleryOn &&
                ".lg-item" === this.settings.appendSubHtmlTo &&
                this.addHtml(e);
          }
          var E = 0;
          v && !mi(document.body).hasClass("lg-from-hash") && (E = v),
            this.isFirstSlideWithZoomAnimation() &&
              (setTimeout(function () {
                s.removeClass(
          ...
          "lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"),
            setTimeout(function () {
              ...
              if (
                ...
                var a = mi(i.target);
                s.isPosterElement(a) && s.LGel.trigger(Hi);
              }
            ...
            this.$inner.on("touchend.lg", function (r) {
              if ("swipe" === e.touchAction) {
                if (n) (n = !1), e.touchEnd(i, t, r);
                  ...
                  var o = mi(r.target);
                  e.isPosterElement(o) && e.LGel.trigger(Hi);
                }
        ...
        (e.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            mi(window).on("mousemove.lg.global" + this.lgId, function (r) {
              n &&
                e.lgOpened &&
                ((s = !0),
            ...
            mi(window).on("mouseup.lg.global" + this.lgId, function (r) {
              if (e.lgOpened) {
                var o = mi(r.target);
                s
                  ? ((s = !1), e.touchEnd(i, t, r), e.LGel.trigger(Wi))
                  : e.isPosterElement(o) && e.LGel.trigger(Hi),
                  n &&
                    ((n = !1),
        ...
        (e.prototype.goToPrevSlide = function (e) {
          ...
          e && this.galleryItems.length < 3 && (i = !1),
            this.lgBusy ||
              (this.index > 0
                ? (this.index--,
                  this.LGel.trigger(qi, { index: this.index, fromTouch: e }),
        ...
        (e.prototype.keyPress = function () {
          var e = this;
          mi(window).on("keydown.lg.global" + this.lgId, function (t) {
            e.lgOpened &&
              !0 === e.settings.escKey &&
              27 === t.keyCode &&
              (t.preventDefault(),
        ...
        (e.prototype.closeGallery = function (e) {
          ...
          this.LGel.trigger(Xi), mi(window).scrollTop(this.prevScrollTop);
          var i,
          ...
          return (
            ...
            setTimeout(function () {
              t.zoomFromOrigin &&
                ...
                t.$inner.empty(),
                t.lgOpened && t.LGel.trigger(Yi, { instance: t }),
          ...
          return (
            setTimeout(function () {
              e.destroyModules(!0),
                ...
                mi(window).off(".lg.global" + e.lgId),
                e.LGel.off(".lg"),
                e.$container.remove();
            }, t),
            t
  ...
  const Qi = function (e, t) {
    ...
    Ji = document.querySelectorAll("[data-gallery]");
  Ji.length &&
    Ji.forEach((e) => {
      Qi(e, { licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E", speed: 500 });
    });
  let Zi = new IntersectionObserver(
      function (e) {
        e.forEach((e) => {
          e.isIntersecting &&
            (e.target.classList.add("sale-show"),
            e.target.classList.add("areas-show"));
        });
      },
      { threshold: [0.5] }
    ),
    en = document.querySelectorAll(".sale,.areas");
  for (let e of en) Zi.observe(e);
  (window.FLS = !0),
    (function (e) {
      let t = new Image();
      (t.onload = t.onerror =
